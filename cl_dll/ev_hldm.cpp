...
void EV_FireGlock1(event_args_t* args)
{
	...
	{
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation(GLOCK_FIRE, 0);
...
void EV_FireShotGunSingle(event_args_t* args)
{
	...
	gEngfuncs.pEventAPI->EV_PlaySound(idx, origin, CHAN_WEAPON, "chicken_fortress_3/shotgun_shoot.wav", gEngfuncs.pfnRandomFloat(0.95, 1.0), ATTN_NORM, 0, 93 + gEngfuncs.pfnRandomLong(0, 0x1f));
...
void EV_FireRpg(event_args_t* args)
{
	...
	gEngfuncs.pEventAPI->EV_PlaySound(idx, origin, CHAN_WEAPON, "chicken_fortress_3/rocketlauncher_shoot.wav", 1.0, ATTN_NORM, 0, PITCH_NORM);
...
void EV_Shovel(event_args_t* args)
{
	...
	if (EV_IsLocal(idx))
	{
		...
		{
		case 0:
			gEngfuncs.pEventAPI->EV_WeaponAnimation(MELEE_SWING_A, 0);
			break;
		case 1:
			gEngfuncs.pEventAPI->EV_WeaponAnimation(MELEE_SWING_B, 0);
			break;
		case 2:
			gEngfuncs.pEventAPI->EV_WeaponAnimation(MELEE_SWING_C, 0);
			break;
		}
	}
}
...
void EV_FireScattergun(event_args_t* args)
{
	...
	if (EV_IsLocal(idx))
	{
		// Add muzzle flash to current weapon model
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation(SCATTERGUN_FIRE, 0);
	...
	gEngfuncs.pEventAPI->EV_PlaySound(idx, origin, CHAN_WEAPON, "chicken_fortress_3/scattergun_shoot.wav", gEngfuncs.pfnRandomFloat(0.95, 1.0), ATTN_NORM, 0, 93 + gEngfuncs.pfnRandomLong(0, 0x1f));
...
void EV_Knife(event_args_t* args)
{
	...
	if (EV_IsLocal(idx))
	{
		...
		{
		case 0:
			gEngfuncs.pEventAPI->EV_WeaponAnimation(KNIFE_SWING_A, 0);
			break;
		case 1:
			gEngfuncs.pEventAPI->EV_WeaponAnimation(KNIFE_SWING_B, 0);
			break;
		case 2:
			gEngfuncs.pEventAPI->EV_WeaponAnimation(KNIFE_SWING_C, 0);
			break;
		}
	}
}
...
void EV_GrenadeLauncher(event_args_t* args)
{
	...
	// gEngfuncs.pEventAPI->EV_PlaySound(idx, origin, CHAN_WEAPON, "chicken_fortress_3/rocketlauncher_shoot.wav", 0.9, ATTN_NORM, 0, PITCH_NORM);
	gEngfuncs.pEventAPI->EV_PlaySound(idx, origin, CHAN_ITEM, "weapons/glauncher.wav", 0.7, ATTN_NORM, 0, PITCH_NORM);

	// Only play the weapon anims if I shot it.
	if (EV_IsLocal(idx))
	{
		gEngfuncs.pEventAPI->EV_WeaponAnimation(GRENADELAUNCHER_SHOOT, 0);
...
void EV_Minigun(event_args_t* args)
{
	...
	if (!args->bparam2)
	{
		...
		case MINIGUN_STATE_STARTSPINNING:
			sample = "rooster_fortress/weapons/minigun_wind_up.wav";
			break;
		case MINIGUN_STATE_SPINNING:
			sample = "rooster_fortress/weapons/minigun_spin.wav";
			break;
		case MINIGUN_STATE_STOPSPINNING:
			sample = "rooster_fortress/weapons/minigun_wind_down.wav";
			break;
		case MINIGUN_STATE_FIRING:
			sample = "rooster_fortress/weapons/minigun_shoot.wav";
			break;
		case MINIGUN_STATE_FIRING_CRIT:
			sample = "rooster_fortress/weapons/minigun_shoot_crit.wav";
			break;
		case MINIGUN_STATE_DRYFIRE:
			sample = "rooster_fortress/weapons/minigun_empty.wav";
			break;
		default:
			break;
		}
...
void EV_FireMinigun(event_args_t* args)
{
	...
	{
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation(MINIGUN_FIRE, 0);
	...
	EV_HLDM_FireBullets(idx, forward, right, up, 4, vecSrc, vecAiming, 8192, BULLET_PLAYER_9MM, 0, &tracerCount[idx - 1], args->fparam1, args->fparam2);
}
...
void EV_SniperRifle(event_args_t* args)
{
	...
	if (EV_IsLocal(idx))
	{
		// Add muzzle flash to current weapon model
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation(SNIPERRIFLE_FIRE, 0);
	...
	EV_HLDM_FireBullets(idx, forward, right, up, 1, vecSrc, vecAiming, 8192, BULLET_PLAYER_TF2_HEADSHOT, 0, &tracerCount[idx - 1], args->fparam1, args->fparam2);
}
...
void EV_Smg(event_args_t* args)
{
	...
	{
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation(SMG_FIRE, 0);
	...
	gEngfuncs.pEventAPI->EV_PlaySound(idx, origin, CHAN_WEAPON, "chicken_fortress_3/smg_shoot.wav", gEngfuncs.pfnRandomFloat(0.92, 1.0), ATTN_NORM, 0, 98 + gEngfuncs.pfnRandomLong(0, 3));

	EV_GetGunPosition(args, vecSrc, origin);

	VectorCopy(forward, vecAiming);

	EV_HLDM_FireBullets(idx, forward, right, up, 1, vecSrc, vecAiming, 8192, BULLET_PLAYER_TF2, 0, &tracerCount[idx - 1], args->fparam1, args->fparam2);
}

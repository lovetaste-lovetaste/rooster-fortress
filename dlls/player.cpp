...
#define ARMOR_RATIO 0.0 // armor takes all of the damage
#define ARMOR_BONUS 1.0 // each point of armor is worth 1 point of health
...
int GetClassMaxHealth(int iClass)
{
	...
	case CLASS_SNIPER:
	case CLASS_SPY:
	case CLASS_ENGINEER: return 125;

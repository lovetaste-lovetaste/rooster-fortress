...
void W_Precache()
{
	...
	g_sModelIndexMiniCritHit = PRECACHE_MODEL("sprites/rooster_fortress/minicrit.spr");
...
void CBasePlayerWeapon::FindHullIntersection(const Vector& vecSrc, TraceResult& tr, const Vector& mins, const Vector& maxs, edict_t* pEntity)
{
	int i, j, k;
	float distance;

...
## Timeline / Plans:
  ### Make the classes functional<br/>
    ...
    - Medic
      - NETWORKED HEALING AND UBERCHARGE
      - everything else is fine ( syringes just projectiles )
    - Engineer buildings
  ...
  ### Gamemodes<br/>
    - Control Points
      ...
      - Medieval Mode
        - just force melee when a specific entity is present in the map
      - King of The Hill
        - Arena Mode ( literally just disable respawns here LMAO )
      - Attack / Defense
    - Capture The Flag
    - Payload
    - Zombie Infection
